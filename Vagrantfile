Vagrant.configure("2") do |config|
  ...
  config.vm.define :local do |box|
    box.vm.hostname = "local.perspektiva360.com"

    # Static IP for testing.
    box.vm.network :private_network, ip: "192.168.108.207"
    box.vm.network :forwarded_port, guest: 22, host: 1827, auto_correct: true
    ...
    # Provision local.perspektiva360.com
